...
INSERT INTO BILLING(TRANSACTION_REFERENCE, CLIENT_SWIFT_ADDRESS, MESSAGE_SATUS, CURRENCY, AMOUNT, DATE_TIME_CREATED)
    VALUES ('TEST1', 'TEST1', 'REC', 'ZAR', 500, '20191001');
INSERT INTO BILLING(TRANSACTION_REFERENCE, CLIENT_SWIFT_ADDRESS, MESSAGE_SATUS, CURRENCY, AMOUNT, DATE_TIME_CREATED)
    VALUES ('TEST2', 'TEST2', 'PEND', 'GBP', 230, '20191206');
INSERT INTO BILLING(TRANSACTION_REFERENCE, CLIENT_SWIFT_ADDRESS, MESSAGE_SATUS, CURRENCY, AMOUNT, DATE_TIME_CREATED)
    VALUES ('TEST3', 'TEST3', 'AWMA', 'ZAR', 220, '20191109');
INSERT INTO BILLING(TRANSACTION_REFERENCE, CLIENT_SWIFT_ADDRESS, MESSAGE_SATUS, CURRENCY, AMOUNT, DATE_TIME_CREATED)
    VALUES ('TEST4', 'TEST4', 'COMP', 'ZAR', 900, '20191110');
INSERT INTO BILLING(TRANSACTION_REFERENCE, CLIENT_SWIFT_ADDRESS, MESSAGE_SATUS, CURRENCY, AMOUNT, DATE_TIME_CREATED)
    VALUES ('TEST5', 'TEST5', '', 'ZAR', 100, '20191210');